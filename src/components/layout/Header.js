...
const Header = ({ arabic }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between bg-white lg:px-[7.29166666667vw] px-[20px] lg:py-[0.58958333333vw] py-[12px]">
          <div className="flex items-center lg:gap-x-[5.10416666667vw] gap-x-[30px]">
            <Link
              href="#"
              className="relative z-[2] block lg:w-[4.99479166667vw] lg:h-[4.15625vw] w-[85px] h-[70px]"
            >
              <Image fill src="/images/icons/footer-logo.svg" alt="logo" />
            </Link>
            <nav className="lg:m-[unset]  capitalize lg:block flex items-center gap-x-[15px]">
              <ul className="sideBar w-full lg:w-[unset] h-[100vh] lg:h-[unset] fixed top-0 lrf1 lg:static lg:text21 mtext18 f500 flex flex-col lg:flex-row justify-center lg:px-[unset] px-[20px] lg:gap-x-[2.91666666667vw] gap-y-[20px]">
                {Links?.map((link, index) => (
                  <li
                    key={index}
